...
public class GameView extends View {
    ...
    /**
     * 게임오버인지 체크하여 게임오버이면 데모 모드로 전환
     *  : 공을 따라 패들의 x좌표가 함께 이동하는 데모 시연
     *  : 데모 시연을 하며 터치 이벤트 잠시 중지하고 유저의 선택 대기
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(m_isDemo){
            ...
            // \n으로 연결된 3개의 문장을 나누어 줄을 바꾸어 한 줄씩 출력
